...
"""
a función busqueda_lineal() devuelve una tupla: (match(True/False) , iter_lin(contador)) en ese orden.
Lo que hago en la línea (encontrado,iter_lin) = busqueda_lineal(lista, objetivo) es llamar a la función 
(que devuelve una tupla) y desempaquetar la tupla (seguir el mismo orden es muy importante).
"""
